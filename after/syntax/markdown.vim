...
execute 'syntax match mkdTag ' . '/\V\zs' . g:mkdd_tag_prefixes . '\_[^ ()]\{2,}/ contains=@mkdMath containedin=mkdNonListItem,mkdListItem,mkdListItemLine,@mkdCode,@mkdCodeDelimiter,@mkdCodeStart,@mkdCodeEnd'
