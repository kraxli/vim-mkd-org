...
augroup mkdd_cmd
  ...
  if !hasmapto('ToggleStatus')
    ...
    au Filetype markdown,text
      ...
      \ | execute 'vnoremap <silent> <buffer> ' . g:mkdd_mapping_switch_status . ' :ToggleStatus<cr>'
      "\ execute 'nnoremap <silent> <buffer> ' . g:mkdd_mapping_switch_status . ' :call markdown#ToggleStatus()<CR>'
  endif
